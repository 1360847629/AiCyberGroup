...
/**
 * A DTO for the {@link org.cyberwarriors.domain.JobReport} entity.
 */
...
public class JobReportDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobReportDTO)) {
            return false;
        }

        JobReportDTO jobReportDTO = (JobReportDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, jobReportDTO.id);
    }
