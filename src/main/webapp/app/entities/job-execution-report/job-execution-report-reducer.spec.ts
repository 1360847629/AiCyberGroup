...
import reducer, {
  ...
  reset,
  updateEntity,
} from './job-execution-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBEXECUTIONREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBEXECUTIONREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBEXECUTIONREPORT actions', async () => {
      const arg = { id: 25755 };
    ...
    it('dispatches UPDATE_JOBEXECUTIONREPORT actions', async () => {
      const arg = { id: 25755 };
    ...
    it('dispatches PARTIAL_UPDATE_JOBEXECUTIONREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOBEXECUTIONREPORT actions', async () => {
      const arg = 42666;
