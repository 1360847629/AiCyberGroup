...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBREPORT actions', async () => {
      const arg = { id: 30527 };
    ...
    it('dispatches UPDATE_JOBREPORT actions', async () => {
      const arg = { id: 30527 };
    ...
    it('dispatches PARTIAL_UPDATE_JOBREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOBREPORT actions', async () => {
      const arg = 42666;
