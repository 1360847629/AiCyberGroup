...
import reducer, {
  ...
  reset,
  updateEntity,
} from './sanitization-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SANITIZATIONREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SANITIZATIONREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SANITIZATIONREPORT actions', async () => {
      const arg = { id: 17269 };
    ...
    it('dispatches UPDATE_SANITIZATIONREPORT actions', async () => {
      const arg = { id: 17269 };
    ...
    it('dispatches PARTIAL_UPDATE_SANITIZATIONREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SANITIZATIONREPORT actions', async () => {
      const arg = 42666;
