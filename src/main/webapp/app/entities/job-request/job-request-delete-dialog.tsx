...
import { deleteEntity, getEntity } from './job-request.reducer';
...
export const JobRequestDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/job-request${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cyberClinicApp.jobRequest.delete.question">
        <Translate contentKey="cyberClinicApp.jobRequest.delete.question" interpolate={{ id: jobRequestEntity.id }}>
