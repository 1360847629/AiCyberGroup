...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBREQUEST actions', async () => {
      const arg = { id: 26991 };
    ...
    it('dispatches UPDATE_JOBREQUEST actions', async () => {
      const arg = { id: 26991 };
    ...
    it('dispatches PARTIAL_UPDATE_JOBREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOBREQUEST actions', async () => {
      const arg = 42666;
